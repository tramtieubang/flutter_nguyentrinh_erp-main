...
import '../work_registered_detail_screen.dart';
import 'work_registered_info.dart';

class WorkRegisteredItemCard extends StatelessWidget {
  final WorkRegisteredModel item;

  const WorkRegisteredItemCard({super.key, required this.item});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => WorkRegisteredDetailScreen(
              title: item.title,
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            ...
            /// 📄 THÔNG TIN CÔNG VIỆC
            Expanded(child: WorkRegisteredInfo(item: item)),
