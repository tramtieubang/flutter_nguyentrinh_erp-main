...
import '../work_assignment_detail_screen.dart';
import 'work_assignment_info.dart';

class WorkAssignmentItemCard extends StatelessWidget {
  final WorkAssignmentModel item;

  const WorkAssignmentItemCard({super.key, required this.item});
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => WorkAssignmentDetailScreen(
              title: item.title,
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            ...
            /// 📄 THÔNG TIN CÔNG VIỆC
            Expanded(child: WorkAssignmentInfo(item: item)),
